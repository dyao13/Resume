...
\textbf{Relevant Coursework:} Probability, Mathematical Statistics, Optimization, Computational Mathematics, Linear Signals and Systems, Multivariate Calculus, Linear Algebra, Differential Equations

\vspace{-9pt}

% skills section
\section*{Skills}
\textbf{Languages:} Python, R, Julia, MATLAB, SQL, Bash \\
...
\begin{itemize}
  ...
  \item Scraped e-sports games using beautifulsoup4 and logged 100,000 ranked games with BrawlStarsAPI
\end{itemize}
